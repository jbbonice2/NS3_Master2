#!/usr/bin/env python3
"""
Script de visualisation pour les simulations LoRaWAN statiques
...
def create_interference_plots(df, output_dir, colors):
    ...
    # 2. Histogramme des pertes d'interférence
    plt.figure(figsize=(12, 8))
...
def generate_report(df, output_dir):
    ...
    with open(report_file, 'w') as f:
        f.write("=== RAPPORT DE SIMULATION LORAWAN STATIQUE ===\n\n")
...
def main():
    parser = argparse.ArgumentParser(description='Visualisation des résultats de simulation LoRaWAN statique')
    parser.add_argument('result_dir', nargs='?', default='lorawan_static_results',
